...
Describe "azure-keyvault-module" {
    ...
    It "returns Id of the Key Vault KV" {
        terraform output --json "key_vault_id_kv" | 
        ConvertFrom-Json |
        Should -Not -BeNullOrEmpty
    }
    ...
    It "returns resource_versionless_id" {
        terraform output --json "resource_versionless_id" | 
        ConvertFrom-Json |
        Should -Not -BeNullOrEmpty
    }
