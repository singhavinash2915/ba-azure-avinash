...
Describe "azure-app-service-plan-module" {
    ...
    It "returns Id of the created App Service Plan" {
        terraform output --json "app_service_plan_id" | 
        ConvertFrom-Json |
       Should -Not -BeNullOrEmpty
     }
    It "returns Id of the created App Service Plan compatibility" {
        terraform output --json "app_service_plancomp_id" | 
        ConvertFrom-Json |
       Should -Not -BeNullOrEmpty
     }
     It "returns Name of the created App Service Plan" {
        terraform output --json "app_service_plan_name" | 
        ConvertFrom-Json |
         Should -Not -BeNullOrEmpty
     }
     It "returns Azure location of the created App Service Plan" {
        terraform output --json "app_service_plan_location" | 
        ConvertFrom-Json |
        Should -Be "westeurope"
     }
   
     It "returns Kind of App Service Plan" {
        terraform output --json "app_service_plan_kind" | 
        ConvertFrom-Json |
        Should -Be "linux"
     }
     It "returns Kind of App Service Plan Compatibility" {
        terraform output --json "app_service_plancomp_kind" | 
        ConvertFrom-Json |
        Should -Be "linux"
     }
