locals {
  ...
  windows_app_settings = {
    ...
    ASPNETCORE_FORWARDEDHEADERS_ENABLED = "true" # Enable Forward Headers
    ASPNETCORE_ENVIRONMENT              = "Production"
  }
  app_settings = merge(local.default_app_settings, local.windows_app_settings, var.app_settings)
