...
Describe "azure-storage-module" {
    ...
    It "returns The ID of the storage account." {
    ...
    It "returns The minimum TLS version for the storage account." {
        terraform output --json "storage_min_tls_version" | 
        ConvertFrom-Json |
        Should -Not -BeNullOrEmpty
    }
    ...
    It "returns The indicator whether the storage account activates static website hosting." {
        terraform output --json "static_website_enabled_staticwebsiteRAGRS" | 
        ConvertFrom-Json |
        Should -Not -BeNullOrEmpty
    }
    It "returns The endpoint URL for web storage in the primary location." {
        terraform output --json "primary_web_endpoint_staticwebsiteRAGRS" | 
        ConvertFrom-Json |
        Should -Not -BeNullOrEmpty
    }
    It "returns The hostname with port if applicable for web storage in the primary location." {
        terraform output --json "primary_web_host_staticwebsiteRAGRS" | 
        ConvertFrom-Json |
        Should -Not -BeNullOrEmpty
    }
    It "returns The endpoint URL for web storage in the secondary location." {
        terraform output --json "secondary_web_endpoint_staticwebsiteRAGRS" | 
        ConvertFrom-Json |
        Should -Not -BeNullOrEmpty
    }
    It "returns The hostname with port if applicable for web storage in the secondary location." {
        terraform output --json "secondary_web_host_staticwebsiteRAGRS" | 
        ConvertFrom-Json |
        Should -Not -BeNullOrEmpty
    }

    #
    It "returns The ID of the iplist storage account." {
        terraform output --json "storage_id_iplist" | 
        ConvertFrom-Json |
        Should -Not -BeNullOrEmpty
    }
}